...
export function StatementUpload() {
  ...
  const handleFileUpload = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (!allowedTypes.includes(file.type) && !file.name.match(/\.(csv|txt|pdf|tsv)$/i)) {
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm border border-slate-200">
        ...
        <div className="space-y-4">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600 mb-4">
                  Upload CSV, TXT, PDF, or TSV files. Our AI will automatically extract and categorize transactions.
                </p>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-medium text-blue-900">
                    {isUploading ? "Uploading file..." : "Analyzing statement with AI..."}
                  </p>
                  <p className="text-sm text-blue-700">
                    {isUploading ? "Please wait while we upload your file." : "This may take a few moments."}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-slate-50 rounded-lg p-4">
            <h5 className="font-medium text-slate-900 mb-2">📋 Supported Formats</h5>
            <ul className="text-sm text-slate-600 space-y-1">
              <li>• <strong>CSV files:</strong> Exported from your bank or credit card website</li>
              <li>• <strong>PDF statements:</strong> Monthly statements (text-based, not scanned images)</li>
              <li>• <strong>TXT files:</strong> Plain text transaction exports</li>
              <li>• <strong>TSV files:</strong> Tab-separated transaction data</li>
            </ul>
            
            <div className="mt-3 pt-3 border-t border-slate-200">
              <p className="text-xs text-slate-500">
                <strong>Privacy:</strong> Your files are processed securely and automatically deleted after analysis.
                We only extract transaction data to populate your expense tracker.
              </p>
            </div>
          </div>
        </div>
